    ...
    <ThemedView style={[styles.screen, { backgroundColor: background }]}>
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        <View style={styles.content}>
          ...
          <SettingsRow action={action} border={border} icon="log-in-outline" label="Account" detail="Sign in when account access is available" onPress={() => router.push('/auth/sign-in')} />
        </View>
      </ScrollView>
    </ThemedView>
  );
